        ...
        function () {
            return function (t) {
                ...
                u.prototype = {
                    ...
                    initialCurrentNumber: function () {
                        var t = this;
                        return g() || m() ? t.currentNumber || (t.currentNumber = y(1, parseInt("10"))) : t.currentNumber = parseInt(h("goeasyNode")),
                            t.currentNumber > 0 && t.currentNumber < this.maxNumber ? t.currentNumber = t.currentNumber + 1 : t.currentNumber == this.maxNumber ? t.currentNumber = 1 : t.currentNumber = Math.floor(Math.random() * this.maxNumber + 1),
                            g() || m() || l("goeasyNode", t.currentNumber),
                            t.currentNumber
                    }
                };
                var p = function (t) {
                ...
                k.goEasyDomainNumber = v,
                    k.isWx = m,
                    m() ? wx._GoEasy_ = k : window._GoEasy_ = k,
                    ...
                    d.prototype.indexOfGuid = function (t) {
                    ...
                    k.prototype = {
                        ...
                        _copyConfig: function (t) {
                            this._appkey = t.appkey,
                                this._otp = t.otp,
                                this._isEmpty(t.userId) ? (this._userId = "anonymous-" + Math.floor(1e5 * Math.random() + 1), t.userId = this._userId) : this._userId = this._trim(t.userId),
                                this._isEmpty(t.userData) ? this._userData = "" : this._userData = this._trim(t.userData),
                                1 == t.debug && (this.debug = !0)
                        },
                        subscribe: function (t) {
                            if (a("subscribe() subscribe:" + JSON.stringify(t)), this._isEmpty(t.channel)) return a("subscribe() 'channel' is required."),
                                void ("undefined" != typeof t.onFailed && t.onFailed({
                                    code: 400,
                                    content: "channel is required"
                                }));
                            this.subscribeBuffer[t.channel] = t,
                                a("subscribe() add subscription into subscribeBuffer:" + JSON.stringify(this.subscribeBuffer[t.channel]));
                            var e = this;
                        ...
                        doSubscribe: function (t) {
                            ...
                            var e = this;
                            if (200 == e.authorizeResult.code) if (this._isEmpty(t.channel)) a("doSubscribe() subscribe failed with empty channel"),
                                e.sendlogs(),
                                t.finish = !0;
                            else {
                                var n = {
                                ...
                                a("doSubscribe() emit subscribe params:" + JSON.stringify(n)),
                                    e.socket.emit("subscribe", n,
                                        function (n) {
                                            a("doSubscribe() receive subscribe ack:" + JSON.stringify(n)),
                                                1 != t.finish && (t.finish = !0, delete e.subscribeBuffer[t.channel], a("doSubscribe() delete subscription from subscribeBuffer:" + JSON.stringify(t)), 200 == n.resultCode ? (e.channels[t.channel] = t, "undefined" != typeof t.onSuccess && t.onSuccess()) : "undefined" != typeof t.onFailed && t.onFailed({
                                                    code: n.resultCode,
                                                    content: n.content
                                                }))
                                        })
                        ...
                        doSubscribeAndCheckAck: function (t) {
                            a("doSubscribeAndCheckAck():" + JSON.stringify(t)),
                                t.finish = !1;
                            var e = this;
                            e.doSubscribe(t);
                        ...
                        unsubscribe: function (t) {
                            function e() {
                                200 == o.authorizeResult.code ? o.socket.emit("unsubscribe", {
                                    ...
                                    function (e) {
                                        i = !0,
                                            200 == e.resultCode ? (delete o.channels[t.channel], a("doUnsubscribe() delete from channels:" + JSON.stringify(t)), "undefined" != typeof t.onSuccess && t.onSuccess()) : "undefined" != typeof t.onFailed && t.onFailed({
                                                code: e.resultCode,
                                                content: e.content
                                            })
                            ...
                            if (this._isEmpty(t.channel)) return this.log("'channel' is required."),
                                void ("undefined" != typeof t.onFailed && t.onFailed({
                                    code: 400,
                                    content: "channel is required"
                                }));
                            if ("undefined" == typeof this.channels[t.channel]) return this.log("'channel' is not subscribed."),
                                void ("undefined" != typeof t.onFailed && t.onFailed({
                                    code: 400,
                            ...
                            var o = this,
                                i = !1,
                                r = 0;
                            if (null != this.authorizeResult && "connected" == o.networkStatus) n();
                        ...
                        publish: function (t) {
                            ...
                            if (this._isEmpty(t.message)) return this.log("'message' is required."),
                                void ("undefined" != typeof t.onFailed && t.onFailed({
                                    code: 400,
                        ...
                        history: function (t, e) {
                            return this._isEmpty(t.channel) ? void ("undefined" != typeof e && e({
                                code: 400,
                                content: "channel is required"
                            })) : void this.socket.emit("historyMessages", t,
                                function (t) {
                                    "undefined" != typeof e && e(t)
                                })
                        },
                        ...
                        _callbackEvents: function (t) {
                            ...
                            this.socket.on("message",
                                function (t, n) {
                                    var o = JSON.parse(t);
                                    e.receivedGuids.unshiftGuid(o.i) || (o.a && e.socket.emit("ack", {
                                        publishGuid: o.i
                                    }), e._endWith(o.n, "presence") ? "undefined" != typeof e.channels[o.n].onPresence && e.channels[o.n].onPresence(JSON.parse(o.c)) : "undefined" != typeof e.channels[o.n].onMessage && e.channels[o.n].onMessage({
                                        time: o.t,
                                        channel: o.n,
                                        content: o.c
                                    }))
                                ...
                                this.socket.on("connect",
                                    function () {
                                        function n() {
                                            a("doAuthorize() emit authorize params:" + JSON.stringify(o)),
                                                e._isEmpty(o.artifactVersion) && e.sendlogs(),
                                                e.socket.emit("authorize", o,
                                                    function (n) {
                                                        if (a("doAuthorize() received authorize ack:" + JSON.stringify(n)), !i) if (i = !0, e.authorizeStatus = "authorized", e._manualDisconnectStatus = "initial", null == e.authorizeResult && (e.authorizeResult = {}), e.authorizeResult.code = n.resultCode, e.authorizeResult.content = n.content, 200 == n.resultCode) {
                                                            if (null == e.authorizeResult.sid) e.authorizeResult.sid = n.sid;
            ...
            function (t, e, n) {
                ...
                function o(t, e) {
                    ...
                    return f ? n = c(s, e) : (a[u] || (a[u] = c(s, e)), n = a[u]),
            ...
            function (t, e, n) {
                ...
                function o(t, e) {
                    ...
                    e = e || "undefined" != typeof location && location,
                        ...
                        "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? e.protocol + t : e.host + t), /^(https?|wss?):\/\//.test(t) || (t = "undefined" != typeof e ? e.protocol + "//" + t : "https://" + t), n = i(t)),
            ...
            function (t, e) {
                ...
                t.exports = function (t) {
                    ...
                    for (var s = n.exec(t || ""), c = {},
                        a = 14; a--;) c[o[a]] = s[a] || "";
                    return i != -1 && r != -1 && (c.source = e, c.host = c.host.substring(1, c.host.length - 1).replace(/;/g, ":"), c.authority = c.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), c.ipv6uri = !0),
                        c
                }
            },
            function (t, e) {
            ...
            function (t, e, n) {
                ...
                function o(t, e) {
                    ...
                    t && "object" === ("undefined" == typeof t ? "undefined" : i(t)) && (e = t, t = void 0),
                        e = e || {},
                ...
                var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
                    ...
                    u = n(32),
                    p = n(33),
                    h = (n(4)("socket.io-client:manager"), n(29)),
                    f = n(34),
                ...
                t.exports = o,
                    ...
                    o.prototype.destroy = function (t) {
                        var e = h(this.connecting, t); ~e && this.connecting.splice(e, 1),
                    ...
                    o.prototype.reconnect = function () {
                        ...
                        var t = this;
                        if (this.backoff.attempts >= this._reconnectionAttempts) this.backoff.reset(),
            ...
            function (t, e, n) {
                ...
                var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
                    ...
                    s = n(11),
                    c = n(6),
                    a = (n(4)("engine.io-client:socket"), n(29)),
                    u = n(15),
                    p = n(3),
                    h = n(22);
                t.exports = o,
                    ...
                    o.prototype.open = function () {
                        var t;
                        if (this.rememberUpgrade && o.priorWebsocketSuccess && this.transports.indexOf("websocket") !== -1) t = "websocket";
                        else {
                                    ...
                                    if (!p) if ("pong" === t.type && "probe" === t.data) {
                                        ...
                                        o.priorWebsocketSuccess = "websocket" === u.name,
                                            h.transport.pause(function () {
                                                p || "closed" !== h.readyState && (a(), h.setTransport(u), u.send([{
                                                    type: "upgrade"
                    ...
                    o.prototype.onOpen = function () {
                        if (this.readyState = "open", o.priorWebsocketSuccess = "websocket" === this.transport.name, this.emit("open"), this.flush(), "open" === this.readyState && this.upgrade && this.transport.pause) for (var t = 0,
                ...
                function o(t) {
                    ...
                    if ("undefined" != typeof location) {
                        var o = "https:" === location.protocol,
                            r = location.port;
                        r || (r = o ? 443 : 80),
                            e = t.hostname !== location.hostname || r !== t.port,
                            n = t.secure !== o
                    }
                    return t.xdomain = e,
                        t.xscheme = n,
            ...
            function (t, e, n) {
                (function (e) {
                    ...
                    function r(t) {
                        if (s.call(this, t), this.query = this.query || {},
                            !a) {
                            var e = i();
                            a = e.___eio = e.___eio || []
                        }
                        ...
                        a.push(function (t) {
                            ...
                            "function" == typeof addEventListener && addEventListener("beforeunload",
                                function () {
                ...
                c(o, i),
                    ...
                    o.prototype.pause = function (t) {
                        ...
                        if (this.readyState = "pausing", this.polling || !this.writable) {
                            var o = 0;
                            this.polling && (o++, this.once("pollComplete",
                                function () {
                                    --o || e()
                                })),
                                this.writable || (o++, this.once("drain",
                                    function () {
                                        --o || e()
                                    }))
                        } else e()
            ...
            function (t, e, n) {
                function o(t) {
                    ...
                    if (i(t)) {
                        for (var e = 0,
                            n = t.length; e < n; e++) if (o(t[e])) return !0;
                        return !1
                    }
                ...
                function n(t, e, n) {
                    function i(t, o) {
                        if (i.count <= 0) throw new Error("after called too many times"); --i.count,
                            t ? (r = !0, e(t), e = n) : 0 !== i.count || r || e(null, o)
                    }
                    var r = !1;
                    return n = n || o,
                        i.count = t,
            ...
            function (t, e) {
                "use strict";
                function n(t) {
                    for (var e, n, o = [], i = 0, r = t.length; i < r;) e = t.charCodeAt(i++),
                        e >= 55296 && e <= 56319 && i < r ? (n = t.charCodeAt(i++), 56320 == (64512 & n) ? o.push(((1023 & e) << 10) + (1023 & n) + 65536) : (o.push(e), i--)) : o.push(e);
                    return o
                }
                function o(t) {
                    for (var e, n = t.length,
                        o = -1,
                        i = ""; ++o < n;) e = t[o],
                            e > 65535 && (e -= 65536, i += d(e >>> 10 & 1023 | 55296), e = 56320 | 1023 & e),
                            i += d(e);
                    return i
                }
                function i(t, e) {
                ...
                function s(t, e) {
                    ...
                    var n = "";
                    return 0 == (4294965248 & t) ? n = d(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (i(t, e) || (t = 65533), n = d(t >> 12 & 15 | 224), n += r(t, 6)) : 0 == (4292870144 & t) && (n = d(t >> 18 & 7 | 240), n += r(t, 12), n += r(t, 6)),
                        n += d(63 & t | 128)
                }
                function c(t, e) {
                    e = e || {};
                    for (var o, i = !1 !== e.strict,
                        r = n(t), c = r.length, a = -1, u = ""; ++a < c;) o = r[a],
                            u += s(o, i);
                    return u
                }
                function a() {
            ...
            function (t, e) {
                ...
                "undefined" != typeof Blob && (o.prototype = Blob.prototype, i.prototype = Blob.prototype),
                    t.exports = function () {
            ...
            function (t, e) {
                e.encode = function (t) {
                    ...
                    e.decode = function (t) {
                        for (var e = {},
                            n = t.split("&"), o = 0, i = n.length; o < i; o++) {
                            var r = n[o].split("=");
            ...
            function (t, e) {
                ...
                for (var r, s = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), c = 64, a = {},
                    u = 0, p = 0; p < c; p++) a[s[p]] = p;
                i.encode = n,
                    i.decode = o,
                    t.exports = i
            },
            ...
            function (t, e, n) {
                ...
                function o(t) {
                    ...
                    e && (this.supportsBinary = !1),
                        "undefined" != typeof wx && "undefined" == typeof WebSocket || (this.perMessageDeflate = t.perMessageDeflate, this.usingBrowserWebSocket = i && !t.forceNode, this.protocols = t.protocols, this.usingBrowserWebSocket || (h = r)),
                        s.call(this, t)
                }
                var i, r, s = n(14),
                    c = n(15),
                ...
                if ("undefined" == typeof wx || "undefined" != typeof WebSocket) if ("undefined" != typeof WebSocket) i = WebSocket;
                else if ("undefined" != typeof self) i = self.WebSocket || self.MozWebSocket;
                else try {
                    r = n(28)
                } catch (t) { }
                var h = i || r;
                "undefined" != typeof wx && "undefined" == typeof WebSocket && (h = function (t) {
                    ...
                    o.prototype.doOpen = function () {
                        if (this.check()) {
                            ...
                            var n;
                            n = "undefined" != typeof wx && "undefined" == typeof WebSocket ? {
                                agent: this.agent
                            } : {
                                    agent: this.agent,
                    ...
                    o.prototype.write = function (t) {
                        ...
                        for (var o = t.length,
                            ...
                            r = o; i < r; i++) !
                                function (t) {
                                    c.encodePacket(t, n.supportsBinary,
                                        function (i) {
            ...
            function (t, e, n) {
                ...
                var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
                    ...
                    a = n(32),
                    u = n(33),
                    p = (n(4)("socket.io-client:socket"), n(22)),
                    h = n(17);
                t.exports = e = o;
                var f = {
                    connect: 1,
                ...
                s(o.prototype),
                    ...
                    o.prototype.emit = function (t) {
                        if (f.hasOwnProperty(t)) return l.apply(this, arguments),
                            this;
                        var e = c(arguments),
                            n = {
                        ...
                        return n.options = {},
                            ...
                            "function" == typeof e[e.length - 1] && (this.acks[this.ids] = e.pop(), n.id = this.ids++),
            ...
            function (t, e, n) {
                function o(t, e, n) {
                    ...
                    if (null == h || null == f) {
                        var l = s();
                        null == h && (h = i = [1 | l[0], l[1], l[2], l[3], l[4], l[5]]),
                            null == f && (f = r = 16383 & (l[6] << 8 | l[7]))
                    }
